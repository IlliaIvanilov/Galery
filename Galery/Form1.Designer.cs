...
namespace Galary
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            dowloadBtn.Location = new System.Drawing.Point(1400, 20);
            ...
            RightBtn.Text = ">";
            RightBtn.Location = new System.Drawing.Point(1400, 400);
            ...
            delete.Text = "-";
            delete.Location = new System.Drawing.Point(1400, 520);
            ...
            picture.Location = new System.Drawing.Point(250, 100);
            picture.Size = new System.Drawing.Size(1000, 1000);
            picture.SizeMode = PictureBoxSizeMode.StretchImage;
            this.Controls.Add(picture);
            SetImage(num);
            //int l = Int32.Parse(last_num);
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            //foreach (var s in "images.txt")
            //{
            //    numPath++;
            //    c++;
            //}
            //if(numPath != PathToFile.Count)
            //{
